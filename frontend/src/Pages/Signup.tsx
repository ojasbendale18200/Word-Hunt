        ...
        <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center text-white justify-center px-2 mt-24">
            {
                noDetailsAlert &&
                <div
                    className="alertWarning absolute top-[12%] right-[44%] transition duration-500 m-auto z-10 text-center p-4 mb-4 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 text-lg"
                    role="alert"
                >
