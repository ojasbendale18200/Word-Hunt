    ...
    <div className="text-white">
      {
        <div
          id="glassWA"
          className="alertWarning right-[34.7%] w-[30%] z-10 absolute transition duration-500 m-auto text-center p-4 mb-4 rounded-lg dark:text-yellow-300 bg-[rgba(255,255,255,0.2)] text-lg"
          role="alert"
        >
          ...
          <div className="flex justify-between px-5 mt-8">
            <button
              className="text-white hover:animate-bounce transition duration-500 hover:text-green-500"
              onClick={()=>handleInvitationResponse(sendResponse)}
            >
              Accept
            </button>
            <button className="text-white hover:animate-ping transition duration-500 hover:text-red-500">
              Reject
            </button>
          </div>
        </div>
