            ...
            <div>
                {
                    isAuth ?
                        <div className='text-white flex flex-col py-52 items-center justify-center gap-20'>
                            <Link className='homeComponents skew-y-12 py-5 px-10' id='homeButtons' style={{ "--clr": "yellow" }} to={"/single"}><span>Single-player</span><i></i></Link>
                            <Link className='homeComponents skew-y-12 py-5 px-10' id='homeButtons' style={{ "--clr": "red" }} to={"/multi"}><span>Multi-player</span><i></i></Link>
                        </div>
                        :
