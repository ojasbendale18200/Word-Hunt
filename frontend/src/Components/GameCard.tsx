...
import { countries, animals, names } from "../utils/data";
...
export const GameCard: React.FC<propsTypes> = ({
    ...
    return (
        <div id="glass" className="lg:w-[60vw] border m-auto p-10 rounded-3xl relative">
            <div className="flex justify-center text-2xl mb-10 mt-0" >
                <p>{opponentsName} : </p>
                <p> {opponentsScore} </p>
            </div>
            <div className="hover:cursor-default grid sm:grid-cols-3 grid-cols-2">
                ...
                <div className="flex flex-col justify-center items-center">
                    <p className="text-xl">Bingo says letter</p>
                    <h1 className="text-7xl font-bold">{letter}</h1>
                </div>
                <p className={"mb-10 sm:text-2xl components text-right"}>Your Score - {finalScore}</p>
            </div>
